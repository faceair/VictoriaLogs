...
func (rrc *rollupResultCache) Get(ec *EvalConfig, expr logql.Expr, window int64) (tss []*timeseries, newStart int64) {
	if !ec.mayCache() {
		return nil, ec.Start
	}
...
func (rrc *rollupResultCache) Put(ec *EvalConfig, expr logql.Expr, window int64, tss []*timeseries) {
...
func marshalRollupResultCacheKey(dst []byte, at *auth.Token, expr logql.Expr, window, step int64) []byte {

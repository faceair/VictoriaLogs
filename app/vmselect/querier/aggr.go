...
func removeGroupTags(metricName *storage.MetricName, modifier *logql.ModifierExpr) {
...
func aggrFuncExt(afe func(tss []*timeseries) []*timeseries, argOrig []*timeseries, modifier *logql.ModifierExpr, maxSeries int, keepOriginal bool) ([]*timeseries, error) {

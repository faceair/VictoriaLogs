...
//line app/vmselect/loki/tsdb_status_response.qtpl:5
import (
	qtio422016 "io"
...
//line app/vmselect/loki/tsdb_status_response.qtpl:16
func streamtsdbStatusEntries(qw422016 *qt422016.Writer, a []storage.TopHeapEntry) {
//line app/vmselect/loki/tsdb_status_response.qtpl:16
	qw422016.N().S(`[`)
//line app/vmselect/loki/tsdb_status_response.qtpl:18
	for i, e := range a {
//line app/vmselect/loki/tsdb_status_response.qtpl:18
		qw422016.N().S(`{"name":`)
//line app/vmselect/loki/tsdb_status_response.qtpl:20
		qw422016.N().Q(e.Name)
//line app/vmselect/loki/tsdb_status_response.qtpl:20
		qw422016.N().S(`,"value":`)
//line app/vmselect/loki/tsdb_status_response.qtpl:21
		qw422016.N().D(int(e.Count))
//line app/vmselect/loki/tsdb_status_response.qtpl:21
		qw422016.N().S(`}`)
//line app/vmselect/loki/tsdb_status_response.qtpl:23
		if i+1 < len(a) {
//line app/vmselect/loki/tsdb_status_response.qtpl:23
			qw422016.N().S(`,`)
//line app/vmselect/loki/tsdb_status_response.qtpl:23
		}
//line app/vmselect/loki/tsdb_status_response.qtpl:24
	}
//line app/vmselect/loki/tsdb_status_response.qtpl:24
	qw422016.N().S(`]`)
//line app/vmselect/loki/tsdb_status_response.qtpl:26
}

...
func ParseStream(req *http.Request, callback func(tss []lokipb.Stream) error) error {
...
type unmarshalWork struct {
	wr       lokipb.WriteRequest
	callback func(tss []lokipb.Stream) error
	reqBuf   []byte
}

...
var (
	...
	disableResponseCompression  = flag.Bool("http.disableResponseCompression", true, "Disable compression of HTTP responses for saving CPU resources. By default compression is enabled to save network bandwidth")
